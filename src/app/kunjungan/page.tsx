      ...
      <div className="flex flex-col h-screen">
        ...
        <div className="flex justify-center items-center flex-grow flex-col text-sm md:text-lg">
          ...
          <div className="px-8 pt-8 drop-shadow-lg shadow-black text-center">
            ...
            <p>Foreigner Rp.30.000</p>
            <p>Jumat-Minggu 08.00-16.00 WIB</p>
            <p>Anak-Anak Rp.15.000</p>
            <p>Dewasa Rp.20.000</p>
            <p>Foreigner Rp.40.000</p>
            <p>Jumat-Minggu 16.01-22.00 WIB</p>
            <p>Anak-Anak Rp.20.000</p>
            <p>Dewasa Rp.25.000</p>
            <p>Foreigner Rp.50.000</p>
          </div>
        </div>
      </div>
    </main>
